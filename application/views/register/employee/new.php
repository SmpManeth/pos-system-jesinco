                ...
                <div class="portlet-body form">
                    ...
                    <div class="form-body">
                        <div class="form-group">
                            ...
                            <div class="col-md-7">
                                <input type="text" class="form-control input-sm" placeholder="Enter Name" name="emp_name" id="emp_name">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-3 control-label">Designation :</label>
                            <div class="col-md-7">
                                <input type="text" class="form-control input-sm" placeholder="Enter Designation Here" name="emp_desig" id="emp_desig">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                ...
                                <input type="text" class="form-control input-sm input-inline input-medium" placeholder="Mobile " id="tp2" name="tp2">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-3 control-label">Office Extension :</label>
                            <div class="col-md-9">
                                <input type="text" class="form-control input-sm input-inline input-medium" placeholder="Office Ext" id="of_ext" name="of_ext">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-3 control-label">Email Address :</label>
                            <div class="col-md-9">
                                <input type="text" class="form-control input-sm" placeholder="Personal Email" name="p_email" id="p_email">
                                <input type="text" class="form-control input-sm" placeholder="Office Email" name="o_email" id="o_email">
                            </div>
                        </div>
                        <div class="form-group">
                                    ...
                                    <div class="portlet-body tabs-below">
                                        <div class="row">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8">
                                                    <input type="text" class="form-control input-sm" placeholder="Enter Username" name="username" id="username">
                                                </div>
                                            </div>
                                            <div class="form-group">
                    ...
                    <div class="form-actions">
                        <div class="row">
                            <div class="col-md-offset-3 col-md-9">
                                <button type="button" class="btn btn-success" id="add_emp_btn"><i class="fa fa-save"></i> <span>Submit</span></button>
...
<script>
    $(document).ready(function () {
        ...
        $("#add_emp_btn").click(function () {
            ...
            $.ajax({
                url: "<?php echo base_url("register_c/save_employee") ?>",
                type: 'POST',
                dataType: 'JSON',
