                ...
                <div class="portlet-body form">
                    ...
                    <div class="form-body">
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control input-sm" placeholder="Branch Name" name="company_name" id="company_name">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-3 control-label">Branch Name (For Report ) :</label>
                            <div class="col-md-9">
                                <input type="text" class="form-control input-sm" placeholder="Branch Name for Reporting" name="branch_name_report" id="branch_name_report">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control input-sm input-inline input-medium" placeholder="Telephone" name="email" id="email">
                            </div>
                        </div>
                        <div class="form-group">
...
<script>
    $(document).ready(function () {
        ...
        $("#update_company_btn").click(function () {
            ...
            $.ajax({
                url: "<?php echo base_url("company/save_branch") ?>",
                type: 'POST',
                dataType: 'JSON',
