...
<title>New Purchasing Order</title>
<?php
?>
                    ...
                    <div class="form-body">
                        <div class="form-group well">
                            <div class="col-md-3">
                                ...
                                <input type="hidden" value="" name="id" id="po_id" />
                            ...
                            <div class="col-md-2">
                                ...
                                <input type="text" class="form-control input-sm datepicker" name="del_date" id="del_date" />
                            </div>
                            <div class="col-md-2">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-2">
                                ...
                                <button type="button" class="btn btn-primary btn-sm " id="add_item_btn"><i class="fa fa-plus"></i> <span>Add Item</span></button>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="form-actions">
                        <div class="row">
                            <div class="col-md-12 text-right">
                                ...
                                <button type="button" class="btn btn-sm btn-success" id="finish_po_btn" title="Finish the Purchasing Order."><i class="fa fa-check"></i> <span>Finish</span>&nbsp;&nbsp;<img src="<?php echo base_url("assets/images/377.gif") ?>" width="20" class="hidden"/></button>
                                <button type="button" class="btn btn-sm default" id="cancel_po_btn" title="Cancel the Purchasing Order"><i class="fa fa-times text-danger"></i> Cancel PO</button>
                                <a href="<?php echo base_url("po") ?>" class="btn btn-sm default" title="Save and Go Back"><i class="fa fa-arrow-left"></i> Go Back</a>
                            </div>
                        </div>
                    </div>
                    <?php echo form_close() ?>
...
<script>
    $(document).ready(function () {
        $("#cancel_po_btn,#finish_po_btn").hide();
...
//            Items Information
        ...
        $("#cancel_po_btn").click(function () {
            DJ.Confirm("Do You want to Cancel this Purchasing Order?", function () {
                var id = $("#po_id").val();
                DJ.disable_btn("cancel_po_btn", "Processing");
                $.ajax({
                    ...
                    data: {id: id},
                    success: function (data) {
                        DJ.enable_btn("cancel_po_btn", "Cancel PO");
                        if (data.msg_type == "OK") {
                            DJ.Notify(data.msg, "success");
    ...
    function remove_pre_item_po(ele, id) {
        DJ.Confirm("Are you want to Remove this Item?", function () {
            ...
            $.ajax({
                url: "<?php echo base_url("po/remove_pre_item") ?>",
                type: 'POST',
                dataType: 'JSON',
                data: {id: id},
                success: function (data) {
